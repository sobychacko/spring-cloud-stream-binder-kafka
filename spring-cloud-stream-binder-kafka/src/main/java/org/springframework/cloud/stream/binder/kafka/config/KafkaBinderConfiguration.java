...
import org.springframework.cloud.stream.binder.kafka.core.JaasLoginModuleConfiguration;
...
public class KafkaBinderConfiguration {
	...
	@Bean
	KafkaTopicsInUseInfo topicsInUse() {
		return new KafkaTopicsInUseInfo();
	}

	@Bean
	ProvisioningProvider provisioningProvider() {
		return new KafkaTopicProvisioner(this.configurationProperties, this.adminUtilsOperation, topicsInUse());
	}
	...
	KafkaBinderHealthIndicator healthIndicator(KafkaMessageChannelBinder kafkaMessageChannelBinder) {
		return new KafkaBinderHealthIndicator(topicsInUse(), this.configurationProperties);
	}
